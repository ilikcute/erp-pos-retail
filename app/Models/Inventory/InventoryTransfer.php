...
{
    protected $fillable = ['transfer_number', 'source_location_id', 'destination_location_id', 'transfer_date', 'status', 'remarks', 'created_by', 'posted_by', 'posted_at'];
    protected $casts = ['transfer_date' => 'date', 'posted_at' => 'datetime'];
